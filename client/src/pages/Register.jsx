    ...
    return (
        <div className="flex items-center justify-center min-h-screen">
            <div className="glass-panel w-full max-w-md p-8 fade-in">
                <h2 className="text-3xl font-bold mb-6 text-center" style={{color: 'var(--primary-color)'}}>Create Account</h2>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                    ...
                    <button type="submit" className="w-full mt-2 py-3 px-4 text-white font-bold rounded-lg shadow-lg hover:shadow-cyan-500/50 transform hover:-translate-y-1 transition-all"
                            style={{background: 'linear-gradient(90deg, var(--primary-color), var(--secondary-color))'}}>
                        Sign Up
                    </button>
                </form>
                <div className="mt-6 text-center text-sm text-gray-300">
                    Already have an account? <Link to="/login" className="font-semibold hover:text-cyan-300" style={{color: 'var(--primary-color)'}}>Login</Link>
                </div>
            </div>
        </div>
    );
